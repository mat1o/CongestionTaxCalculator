...
namespace CongestionTaxCalculator.Service.Utilities
{
    public static class ExtentionMethods
    {
        public static bool IsTollFreeVehicle(this CarViewModel vehicle)
        {
            ...
            return Enum.GetValues(typeof(VehicleType)).Cast<VehicleType>().Contains(vehicle.CarTollType.VehicleType);
        ...
        public static float CalculateTollFee(this DateTime date)
        {
            int hour = date.Hour;
